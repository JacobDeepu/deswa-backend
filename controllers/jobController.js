...
export const createJob = async (req, res, next) => {
  try {
    ...
    //update the jobmanager information with job id
    const jobmanager = await JobManager.findById(id);

    jobmanager.jobPosts.push(job._id);
    const updateJobManager = await JobManager.findByIdAndUpdate(id, jobmanager, {
      new: true,
    });
